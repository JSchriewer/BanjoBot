...
namespace BanjoBotCore
{
    ...
    public class CommandModule : ModuleBase<SocketCommandContext>
    {
        ...
        public async Task ShowHistory([Summary("season #")]int season = -1)
        {
            ...
            await _commandController.GetMatchHistory(socketGuildChannel, Context.User, season);
        }
        ...
        public async Task ShowHistory()
        {
            ...
            await _commandController.GetMatchHistory(socketGuildChannel, Context.User);
        }
        ...
        public async Task ShowMyProfile()
        {
            ...
            await _commandController.ShowPlayerProfile(socketGuildChannel, Context.User);
        }
